 ...
 * When button 3 is clicked, change the text in the header's h1 tag to read "jQuery Ninja"
 	...
 	function question7(){
 		$("h1").replaceWith("<h1>jQuery Ninjaaaaaa</h1>");
 	}
 ...
 * $(".city").attr("src", "http://lorempixel.com/g/500/400/food");
 	...
 	function question8(){
 		$(".city").attr("src", "https://dummyimage.com/640x4:3/");
 	}
*/

/** Changes the image to something else but that something is broken image so idk */
